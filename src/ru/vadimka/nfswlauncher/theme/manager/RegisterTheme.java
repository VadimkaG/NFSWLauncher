...
public abstract class RegisterTheme {
	...
	public static ThemeItemNode NODE_SERVER = new ThemeItemNode(555,50,245,30);
	public static ThemeItemNode NODE_LOGIN_LABEL = new ThemeItemNode(0,2,1,1);
	public static ThemeItemNode NODE_LOGIN = new ThemeItemNode(360,425,200,40);
	public static ThemeItemNode NODE_PASSWORD_LABEL = new ThemeItemNode(0,3,1,1);
	...
	public static ThemeItemNode NODE_BUTTON_LOGIN = new ThemeItemNode(587,465,200,40);
		...
		for (int i = 0; i < items.getLength(); i++) {
			...
			case "background":
				...
				if (file.exists() && !file.isDirectory()) {
					...
					Log.print("Фон окна регистрации не найден. Не найденый путь: "+file.getAbsolutePath());
				}
				break;
			case "items":
				...
				for (int ii = 0; ii < parentNodes.getLength(); ii++) {
					...
					case "server":
						...
						break;
					case "invite_label":
						NODE_INVITE.setLabel(ThemeManager.getItem(parentNode.getChildNodes()));
						break;
					case "invite":
						NODE_INVITE.setField(ThemeManager.getItem(parentNode.getChildNodes()));
						break;
					case "login_label":
					...
					case "submit":
						...
						break;
					case "login_b":
						NODE_BUTTON_LOGIN.setField(ThemeManager.getItem(parentNode.getChildNodes()));
						break;
					}
				}
				break;
